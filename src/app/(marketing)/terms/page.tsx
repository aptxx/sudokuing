export default async function Page() {
  return (
    <div className="all-revert-full">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Sudokuing.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Sudokuing, accessible from{' '}
            <a href="https://sudokuing.com" rel="external nofollow noopener" target="_blank">
              https://sudokuing.com
            </a>
          </p>
        </li>
      ...
      <ul>
        <li>By email: support@sudokuing.com</li>
      </ul>
    </div>
  );
}
