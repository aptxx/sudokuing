...
const elements = [
  <div className="block h-[90%] w-[90%] bg-red-500"></div>,
  <div className="block h-[90%] w-[90%] bg-orange-500"></div>,
  <div className="block h-[90%] w-[90%] bg-yellow-500"></div>,
  <div className="block h-[90%] w-[90%] bg-green-500"></div>,
  <div className="block h-[90%] w-[90%] bg-blue-500"></div>,
  <div className="block h-[90%] w-[90%] bg-slate-500"></div>,
  <div className="block h-[90%] w-[90%] bg-purple-500"></div>,
  <div className="block h-[90%] w-[90%] bg-pink-500"></div>,
